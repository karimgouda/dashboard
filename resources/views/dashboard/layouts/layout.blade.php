 ...
 * @license MIT
 ...
 <head>
     ...
     <!-- Icons -->
     <link href="  {{asset("adminAsset/css/font-awesome.min.css")}} " rel="stylesheet">
     <link href="  {{asset("adminAsset/css/simple-line-icons.css")}} " rel="stylesheet">
     <!-- Main styles for this application -->
     <link href="  {{asset("adminAsset/dest/style.css")}} " rel="stylesheet">
 ...
 <body class="navbar-fixed sidebar-nav fixed-nav">
     ...
     <script src=" {{asset("adminAsset/js/libs/jquery.min.js")}}  "></script>
     <script src=" {{asset("adminAsset/js/libs/tether.min.js")}}  "></script>
     <script src=" {{asset("adminAsset/js/libs/bootstrap.min.js")}}  "></script>
     <script src=" {{asset("adminAsset/js/libs/pace.min.js")}}  "></script>

     <!-- Plugins and scripts required by all views -->
     <script src=" {{asset("adminAsset/js/libs/Chart.min.js")}}  "></script>
     ...
     <script src=" {{asset("adminAsset/js/views/main.js")}}  "></script>

     <!-- Grunt watch plugin -->
     <script src="//localhost:35729/livereload.js"></script>
     <script src="https://cdn.datatables.net/autofill/2.5.1/js/dataTables.autoFill.min.js"></script>
     <script src="https://cdn.datatables.net/autofill/2.5.1/js/autoFill.bootstrap4.min.js"></script>
     <script>
